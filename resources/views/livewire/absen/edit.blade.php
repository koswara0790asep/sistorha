                    ...
                    @for ($i = 0; $i < $ulang; $i++) --}}
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan1" name="pertemuan1" wire:model="pertemuan1" class="form-select @error('pertemuan1') is-invalid @enderror" {{ $this->pertemuan1 != null ? 'disabled' : ''}} >
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat1" name="telat1" wire:model="telat1" class="form-control @error('telat1') is-invalid @enderror" {{ $this->pertemuan1 != null ? 'disabled' : ''}} >
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan2" name="pertemuan2" wire:model="pertemuan2" class="form-select @error('pertemuan2') is-invalid @enderror" {{ $this->pertemuan2 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat2" name="telat2" wire:model="telat2" class="form-control @error('telat2') is-invalid @enderror" {{ $this->pertemuan2 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat2')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan3" name="pertemuan3" wire:model="pertemuan3" class="form-select @error('pertemuan3') is-invalid @enderror" {{ $this->pertemuan3 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat3" name="telat3" wire:model="telat3" class="form-control @error('telat3') is-invalid @enderror" {{ $this->pertemuan3 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat3')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan4" name="pertemuan4" wire:model="pertemuan4" class="form-select @error('pertemuan4') is-invalid @enderror" {{ $this->pertemuan4 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat4" name="telat4" wire:model="telat4" class="form-control @error('telat4') is-invalid @enderror" {{ $this->pertemuan4 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat4')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan5" name="pertemuan5" wire:model="pertemuan5" class="form-select @error('pertemuan5') is-invalid @enderror" {{ $this->pertemuan5 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat5" name="telat5" wire:model="telat5" class="form-control @error('telat5') is-invalid @enderror" {{ $this->pertemuan5 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat5')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan6" name="pertemuan6" wire:model="pertemuan6" class="form-select @error('pertemuan6') is-invalid @enderror"  {{ $this->pertemuan6 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat6" name="telat6" wire:model="telat6" class="form-control @error('telat6') is-invalid @enderror"  {{ $this->pertemuan6 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat6')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan7" name="pertemuan7" wire:model="pertemuan7" class="form-select @error('pertemuan7') is-invalid @enderror" {{ $this->pertemuan7 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat7" name="telat7" wire:model="telat7" class="form-control @error('telat7') is-invalid @enderror" {{ $this->pertemuan7 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat7')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan8" name="pertemuan8" wire:model="pertemuan8" class="form-select @error('pertemuan8') is-invalid @enderror" {{ $this->pertemuan8 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat8" name="telat8" wire:model="telat8" class="form-control @error('telat8') is-invalid @enderror" {{ $this->pertemuan8 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat8')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan10" name="pertemuan10" wire:model="pertemuan10" class="form-select @error('pertemuan10') is-invalid @enderror" {{ $this->pertemuan10 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat10" name="telat10" wire:model="telat10" class="form-control @error('telat10') is-invalid @enderror" {{ $this->pertemuan10 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat10')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan11" name="pertemuan11" wire:model="pertemuan11" class="form-select @error('pertemuan11') is-invalid @enderror" {{ $this->pertemuan11 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat11" name="telat11" wire:model="telat11" class="form-control @error('telat11') is-invalid @enderror" {{ $this->pertemuan11 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat11')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan12" name="pertemuan12" wire:model="pertemuan12" class="form-select @error('pertemuan12') is-invalid @enderror" {{ $this->pertemuan12 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat12" name="telat12" wire:model="telat12" class="form-control @error('telat12') is-invalid @enderror" {{ $this->pertemuan12 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat12')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan13" name="pertemuan13" wire:model="pertemuan13" class="form-select @error('pertemuan13') is-invalid @enderror" {{ $this->pertemuan13 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat13" name="telat13" wire:model="telat13" class="form-control @error('telat13') is-invalid @enderror" {{ $this->pertemuan13 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat13')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan14" name="pertemuan14" wire:model="pertemuan14" class="form-select @error('pertemuan14') is-invalid @enderror" {{ $this->pertemuan14 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat14" name="telat14" wire:model="telat14" class="form-control @error('telat14') is-invalid @enderror" {{ $this->pertemuan14 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat14')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <span class="badge rounded-pill {{ $tglAbsen15 == 'BAP Belum Terisi' ? 'bg-danger' : 'bg-info' }}">{{ $tglAbsen15 }}</span>
                                <div class="mb-3 input-group">
                                    <select id="pertemuan15" name="pertemuan15" wire:model="pertemuan15" class="form-select @error('pertemuan15') is-invalid @enderror" {{ $this->pertemuan15 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat15" name="telat15" wire:model="telat15" class="form-control @error('telat15') is-invalid @enderror" {{ $this->pertemuan15 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat15')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan16" name="pertemuan16" wire:model="pertemuan16" class="form-select @error('pertemuan16') is-invalid @enderror" {{ $this->pertemuan16 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat16" name="telat16" wire:model="telat16" class="form-control @error('telat16') is-invalid @enderror" {{ $this->pertemuan16 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat16')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <select id="pertemuan17" name="pertemuan17" wire:model="pertemuan17" class="form-select @error('pertemuan17') is-invalid @enderror" {{ $this->pertemuan17 != null ? 'disabled' : ''}} >
                                        <option value="" hidden>--- Hadir/Alfa/Sakit/Izin ---</option>
                                        <option value="Hadir">Hadir</option>
                                        <option value="Alfa">Alfa</option>
                                        <option value="Sakit">Sakit</option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 input-group">
                                    <input type="time" id="telat17" name="telat17" wire:model="telat17" class="form-control @error('telat17') is-invalid @enderror" {{ $this->pertemuan17 != null ? 'disabled' : ''}} >
                                    <span class="input-group-text"><h4><i class="mdi mdi-clock-alert"></i></h4></span>
                                    @error('telat17')
                                    <span class="invalid-feedback">
                                        {{ $message }}
