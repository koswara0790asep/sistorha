<div class="section_our_solution">
    <style>
        ...
        .solution_card .solu_description .edit_btn {
            border: 0;
            border-radius: 15px;
            background: linear-gradient(140deg,
                    #1226ff 0%,
        ...
        .solution_card .solu_description .delete_btn {
            border: 0;
            border-radius: 15px;
            background: linear-gradient(140deg,
                    #f10000 0%,
    ...
    <a href="{{ route('prodi.create') }}" class="shadow btn btn-success mb-3"><i class="icon-add"></i> TAMBAH
        PEMBERITAHUAN</a>
    @endif
    <div class="row">
                ...
                <div class="solution_cards_box">
                    ...
                    <div class="solution_card">
                        ...
                        <div class="solu_description">
                            <p>
                                Program Studi: {{ $pgs->nama_prodi }}
                            </p>
                            <a href="{{ route('prodi.show', $pgs->id) }}"><button type="button" class="read_more_btn"><i
                                        class="icon-eye"></i> Read More</button></a>
                            @if (Auth::user()->role == "ADMIN")

                            <a href="{{ route('prodi.edit', $pgs->id) }}"><button type="button" class="edit_btn"><i
